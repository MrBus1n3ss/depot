...
class Depot:
    ...
    def create_dir(self, db, dir_name):  # TODO: figure out how I want to do the db part
...
def create_test_dir(depot_mapping, depot):
    depot.create_dir(depot_mapping, 'test')
